...
<html lang="en">
 ...
 <body> 
  <div class="container"> 
   ...
   <div class="row"> 
    <div class="col-12"> 
       <button type="button" class="btn-punya" onclick="location.href='login.php';">Punya Akun</button> 
    </div> 
    <div class="col-12"> 
     <button type="button" class="btn-belum" onclick="location.href='login.php';">Belum Punya Akun</button> 
    </div> 
   </div> 
  </div> 
