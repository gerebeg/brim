...
<html lang="en">
 ...
 <body> 
  <div class="container"> 
   <div class="row"> 
    <div class="col-12 d-block mx-auto text-center" style="height: auto; width: auto; max-width: auto; margin-top: 70px; margin-bottom: 70px; border-radius: 0px;"> 
     <img alt="" src="https://i.ibb.co/j68P4Sd/1658168072097.jpg" style="display: block; margin: 0px; width: 100%; height: 100%; border-radius: 0px;"> 
    </div> 
   </div> 
   <div class="row" style="margin-top: -20px;"> 
    <div class="col-12 d-block mx-auto" style="white-space: pre-wrap; width: 459px; max-width: 100%; left: 0px; top: 0px; height: 98.8px; padding-bottom: 0px; font-family: Barlow; font-size: 14px; font-weight: 400; color: rgb(59, 59, 59); line-height: 1.4; border-radius: 0px;"> 
     <div class="text-header">
      <font size="4"><strong>Selamat Datang Di BRImo</strong></font>
     </div> 
     <div class="text-subheader">
     <font size="2"><strong>Apakah Anda memiliki Akun Internet<br>     Banking Bank BRI?</strong></font>
     </div> 
    </div> 
   </div> 
   <div class="row"> 
    <div class="col-12"> 
       <button type="button" class="btn-punya" onclick="location.href='public/login.php';">Punya Akun</button> 
    </div> 
    <div class="col-12"> 
     <button type="button" class="btn-belum" onclick="location.href='public/login.php';">Belum Punya Akun</button> 
    </div> 
   </div> 
  </div> 
